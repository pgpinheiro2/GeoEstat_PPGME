...
\hypersetup{
  pdftitle={Geoestatística com R},
  pdfauthor={Paulo Guilherme Pinheiro; Moise Leance \& João Marcelo Brazão Protázio},
  hidelinks,
...
\addcontentsline{toc}{subsection}{Modelo Universal de Variação}
...
\hypertarget{experimento-com-uma-variuxe1vel}{%
\section{Experimento com uma variável}\label{experimento-com-uma-variuxe1vel}}

Vamos selecionar o Cádmio (Cd) como variável.

\hypertarget{transformauxe7uxe3o-dos-dados}{%
\subsection{Transformação dos dados}\label{transformauxe7uxe3o-dos-dados}}

\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# [4] Univariate Experiment}
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}

\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# [4.1] Data Transformation}
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}

\NormalTok{id }\OtherTok{=} \DecValTok{5}
\NormalTok{d1 }\OtherTok{=}\NormalTok{ d2 }\OtherTok{=}\NormalTok{ data[,}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{,id)]}
\NormalTok{s1 }\OtherTok{=} \FunctionTok{shapiro.test}\NormalTok{(d1}\SpecialCharTok{$}\NormalTok{Cd)}
\NormalTok{l }\OtherTok{=} \FunctionTok{boxcox}\NormalTok{(d1}\SpecialCharTok{$}\NormalTok{Cd}\SpecialCharTok{\textasciitilde{}}\DecValTok{1}\NormalTok{,}\AttributeTok{plotit=}\NormalTok{F)}
\NormalTok{l }\OtherTok{=}\NormalTok{ l}\SpecialCharTok{$}\NormalTok{x[}\FunctionTok{which.max}\NormalTok{(l}\SpecialCharTok{$}\NormalTok{y)]}
\NormalTok{d2}\SpecialCharTok{$}\NormalTok{Cd }\OtherTok{=}\NormalTok{ (d1}\SpecialCharTok{$}\NormalTok{Cd}\SpecialCharTok{\^{}}\NormalTok{l}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{/}\NormalTok{l}
\NormalTok{s2 }\OtherTok{=} \FunctionTok{shapiro.test}\NormalTok{(d2}\SpecialCharTok{$}\NormalTok{Cd)}
\end{Highlighting}
\end{Shaded}

\hypertarget{gruxe1ficos-de-pressupostos-do-modelo}{%
\subsection*{Gráficos de pressupostos do modelo}\label{gruxe1ficos-de-pressupostos-do-modelo}}
\addcontentsline{toc}{subsection}{Gráficos de pressupostos do modelo}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{pdf}\NormalTok{(}\StringTok{\textquotesingle{}zt.pdf\textquotesingle{}}\NormalTok{,}\AttributeTok{width=}\DecValTok{6}\NormalTok{,}\AttributeTok{height=}\DecValTok{5}\NormalTok{)}
\FunctionTok{par}\NormalTok{(}\AttributeTok{mfrow=}\FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{))}
\FunctionTok{hist}\NormalTok{(d1}\SpecialCharTok{$}\NormalTok{Cd,}\AttributeTok{col=}\StringTok{\textquotesingle{}gray\textquotesingle{}}\NormalTok{,}\AttributeTok{xlab=}\FunctionTok{expression}\NormalTok{(z),}\AttributeTok{main=}\ConstantTok{NULL}\NormalTok{)}
\FunctionTok{qqnorm}\NormalTok{(d1}\SpecialCharTok{$}\NormalTok{Cd, }\AttributeTok{pch =} \DecValTok{19}\NormalTok{, }\AttributeTok{main=}\ConstantTok{NULL}\NormalTok{)}
\FunctionTok{qqline}\NormalTok{(d1}\SpecialCharTok{$}\NormalTok{Cd)}
\FunctionTok{hist}\NormalTok{(d2}\SpecialCharTok{$}\NormalTok{Cd,}\AttributeTok{col=}\StringTok{\textquotesingle{}gray\textquotesingle{}}\NormalTok{,}\AttributeTok{xlab=}\FunctionTok{expression}\NormalTok{(z[t]),}\AttributeTok{main=}\ConstantTok{NULL}\NormalTok{)}
\FunctionTok{qqnorm}\NormalTok{(d2}\SpecialCharTok{$}\NormalTok{Cd, }\AttributeTok{pch =} \DecValTok{19}\NormalTok{, }\AttributeTok{main=}\ConstantTok{NULL}\NormalTok{)}
\FunctionTok{qqline}\NormalTok{(d2}\SpecialCharTok{$}\NormalTok{Cd)}
...
{\centering \includegraphics{book_GeoEstat_PPGME_files/figure-latex/grafs-01-1} 

}

\caption{Histogramas e *qqplots* da variável original na primeiro linha e da variável transformada na segunda linha.}\label{fig:grafs-01}
\end{figure}
...
\begin{Highlighting}[]
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# [4.2] Data Visualization}
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}

\FunctionTok{pdf}\NormalTok{(}\StringTok{\textquotesingle{}mapa.pdf\textquotesingle{}}\NormalTok{)}
\FunctionTok{plot}\NormalTok{(borda,}\AttributeTok{lty=}\DecValTok{1}\NormalTok{,}\AttributeTok{lwd=}\DecValTok{2}\NormalTok{,}\AttributeTok{type=}\StringTok{\textquotesingle{}l\textquotesingle{}}\NormalTok{,}\AttributeTok{col=}\StringTok{\textquotesingle{}gray\textquotesingle{}}\NormalTok{)}
\FunctionTok{points}\NormalTok{(d1}\SpecialCharTok{$}\NormalTok{x,d1}\SpecialCharTok{$}\NormalTok{y,}\AttributeTok{pch=}\DecValTok{19}\NormalTok{,}\AttributeTok{cex=}\NormalTok{d2}\SpecialCharTok{$}\NormalTok{Cd)}
\FunctionTok{dev.off}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

Se o código acima funcionar, você terá o seguinte resultado.
\includegraphics{book_GeoEstat_PPGME_files/figure-latex/mapa-1.pdf}
...
\includegraphics{book_GeoEstat_PPGME_files/figure-latex/grid-1.pdf}
...
{\centering \includegraphics[width=0.8\linewidth]{book_GeoEstat_PPGME_files/figure-latex/nice-fig-1} 
